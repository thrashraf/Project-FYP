...
export const DeleteNotification = (props: Props) => {
  ...
  return (
    ...
    <div className={`w-full bg-[#00000055]  z-[100] inset-0 ${ props.show ? 'absolute' : 'hidden'}`} onClick={props.notificationHandler}  />
      ...
      <div className={`w-11/12 mx-auto mb-4 my-6 md:w-5/12 shadow sm:px-10 sm:py-6 py-4 px-4 bg-white  rounded-md m-auto transform translate-y-[70%] translate-x-[70%] ${ props.show ? 'absolute' : 'hidden'} z-[200]`}>
